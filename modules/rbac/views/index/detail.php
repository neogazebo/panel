        ...
        <div class="col-md-12 col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <?= Html::button('<i class="fa fa-refresh"></i> &nbsp; Update Permission List', ['value' => Url::to(['get-permission?role='.$title]), 'class' => 'ajaxRequest btn btn-primary btn-sm', 'data-key' => Url::current()]) ?>
                </div>
