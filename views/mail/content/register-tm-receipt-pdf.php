...
<div style="font-size: 34px;color: #f37021;padding: 25px 20px;">Receipt</div>
<table style="width:100%;">
    <tr>
        ...
        <td style="text-align: right;vertical-align: top;padding: 0 20px;color: #828282;width:40%">
            ...
            Receipt Date : <?= Yii::$app->formatter->asDate($data['receipt']->fsr_created) ?><br />
            Billing Period : <?= Yii::$app->formatter->asDate($data['model']->company->mySubscription->fsc_valid_start) ?> - <?= Yii::$app->formatter->asDate($data['model']->company->mySubscription->fsc_valid_end) ?>
        </td>
    </tr>
</table>
<table style="padding: 10px 0;width:100%;">
    ...
    <tr>
        ...
        <td style="text-align: left;border-bottom: 1px solid #c7c5c4;padding: 18px;"></td>
        <td style="text-align: left;border-bottom: 1px solid #c7c5c4;padding: 18px;"></td>
        <td style="text-align: left;border-bottom: 1px solid #c7c5c4;padding: 18px;" class="strong">Total</td>
        <td style="text-align: left;border-bottom: 1px solid #c7c5c4;padding: 18px;" class="strong"><?= Currency::symbol($row->fsc_payment_currency) ?>  <?= $totalAmount; ?></td>
    </tr>
</table>
    ...
    <tr>
        <td valign="top" style="border-bottom: 1px solid #c7c5c4;">
            <div style="padding:20px">
                <div style="font-size: 18px; color: #ec7323; font-weight: bold; text-align: center;">Thank you for your bussiness</div>
