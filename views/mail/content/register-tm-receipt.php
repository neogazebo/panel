        ...
        <td valign="top" class="bodyContent">
            <table border="0" cellpadding="10" cellspacing="0" width="100%" style="padding: 30px 0;">
                ...
                <tr>
                    ...
                    <td class="strong" style="border-bottom: 1px solid #c7c5c4;padding: 20px;text-align: left;font-size: 18px;font-weight: bold;"><?= Currency::symbol($row->fsc_payment_currency) ?> <?=$totalAmount;?></td>
                </tr>
            </table>
        </td>
    </tr>
