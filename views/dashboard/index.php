    ...
    <div class="col-md-6">
        ...
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas id="lineChart" data-url="line-chart"></canvas>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas id="lineRejectChart" data-url="line-chart"></canvas>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="chart">
                        <canvas id="lineApproveChart" data-url="line-chart"></canvas>
                    </div>
                </div>
            </div>
        </div>
