...
<ul class="sidebar-menu">
    ...
    <?php if (AccessFilters::getMenu('voucher')) : ?>
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li>
                    <?php if (Yii::$app->permission_helper->processPermissions('Voucher', 'Voucher[Menus][redemption]')) : ?>
                ...
                <li>
                    <?php if (Yii::$app->permission_helper->processPermissions('Voucher', 'Voucher[Menus][cash_vouchers]')) : ?>
    ...
    <?php if (Yii::$app->permission_helper->processPermissions('Snapearn', 'Snapearn[Menus][Snap & Earn]')) : ?>
        <li class="treeview">
            <a href="#">
            ...
            <ul class="treeview-menu">
                <?php if (Yii::$app->permission_helper->processPermissions('Snapearn', 'Snapearn[Menus][List]')) : ?>
                    <li><a href="<?= Yii::$app->urlManager->createUrl('snapearn') ?>"><i class="fa fa-circle-o"></i> List</a></li>
                <?php endif; ?>

                <?php if (Yii::$app->permission_helper->processPermissions('Snapearn', 'Snapearn[Menus][Working Hours]')) : ?>
